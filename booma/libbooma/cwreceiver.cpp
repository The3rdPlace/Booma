...
BoomaCwReceiver::BoomaCwReceiver(ConfigOptions* configOptions, HWriterConsumer<int16_t>* previous, HWriter<int16_t>* next):
    ...
    _gain = new HGain<int16_t>(_humFilter->Consumer(), configOptions->FirstStageGain, BLOCKSIZE);
    ...
    _volume = new HGain<int16_t>(_lowpass->Consumer(), configOptions->Volume, BLOCKSIZE);
